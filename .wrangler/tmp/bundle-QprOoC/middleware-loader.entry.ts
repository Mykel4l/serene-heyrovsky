...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/project/workspace/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/project/workspace/.wrangler/tmp/bundle-QprOoC/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/project/workspace/.wrangler/tmp/bundle-QprOoC/middleware-insertion-facade.js";
